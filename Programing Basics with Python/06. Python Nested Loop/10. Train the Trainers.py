numbers_of_members_of_the_jury = int(input())
grade_counter = 0
sum_grades = 0
while True:
    problem_name = input()
    ...
    for x in range(numbers_of_members_of_the_jury):
        grade = float(input())
        grade_counter += 1
        sum_grades += grade
        current_grade_counter += grade
    current_average_grade = current_grade_counter / numbers_of_members_of_the_jury
